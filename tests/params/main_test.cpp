...
{
  std::vector<std::tuple<double,double,double>> pc_source = ppc_source.exportCentroidPointCloud_as_vector();
  std::vector<std::tuple<double,double,double>> pc_dest = ppc_dest.exportCentroidPointCloud_as_vector();
